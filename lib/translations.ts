export const translations = {
  en: {
    ...
    experience: {
      ...
      projectsSubtitle: 'A selection of projects I have built or contributed to.',
    ...
    sections: {
      experience: 'Experience',
      experienceDesc: 'Projects & professional experience',
      about: 'About Me',
  ...
  es: {
    ...
    contact: {
      title: 'Contacto',
      subtitle:
        '¿Tienes una pregunta o quieres trabajar juntos? No dudes en ponerte en contacto.',
      location: 'Ubicación',
    ...
    experience: {
      ...
      projectsSubtitle:
        'Una selección de proyectos en los que he trabajado o contribuido.',
    ...
    sections: {
      experience: 'Experiencia',
      experienceDesc: 'Proyectos y experiencia profesional',
      about: 'Sobre Mí',
      aboutDesc: 'Quién soy y qué hago',
      contact: 'Contacto',
      contactDesc: 'Ponte en contacto conmigo',
    },
    // Hero
    hero: {
      greeting: '¡Hola! Soy',
